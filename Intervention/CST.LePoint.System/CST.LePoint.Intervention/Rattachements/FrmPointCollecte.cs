            ...
            if (ValidateChildren())
            {
                ...
                try
                {
                   ...
                   // pc.Latt_PC = Convert.ToDecimal(lat);
                    pc.Latt_PC = Convert.ToDecimal(this.textLat.EditValue);// != null ?Convert.ToDecimal((textLat.EditValue.ToString()) : null;
                    //pc.Long_PC = Convert.ToDecimal(lng);
                    pc.Long_PC = Convert.ToDecimal(this.textLong.EditValue);
