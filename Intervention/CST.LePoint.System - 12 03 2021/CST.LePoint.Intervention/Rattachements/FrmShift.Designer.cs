...
namespace CST.LePoint.Intervention.Rattachements
{
    partial class FrmShift
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.GridVPoste.CellValueChanged += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(this.GridVPoste_CellValueChanged);
