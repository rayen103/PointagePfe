...
namespace CST.LePoint.CtrlLibrary.Satellites
{
    public partial class FrmSatellites : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void InitTreeList()
        {
            ...
            _Satellites.Add(new RefSatellite("Bus", _Satellites.Count, TREE_ID_DIVERS));
                ...
                case "Bus":
                    {
                        ...
                        proprietes.Add(new GvColumnPropriete("IMEI", GvColumnPropriete.GvColumnEtat.Enable));
                        proprietes.Add(new GvColumnPropriete("Capacite Bus", GvColumnPropriete.GvColumnEtat.Enable));
                        proprietes.Add(new GvColumnPropriete("Code Circuit", GvColumnPropriete.GvColumnEtat.Enable));
        ...
        private void Sauvgarder()
        {
            ...
            if (dialogResult != DialogResult.Yes)
                return;
            if (this._NomSatelilte != "Modems" && this._NomSatelilte != "Bus" && this._NomSatelilte != "Chauffeurs" && this._NomSatelilte != "Commercial" && this._NomSatelilte != "Préparateurs" && this._NomSatelilte != "Releveurs")
            {
                    ...
                    case "Bus":
                        {
                            ...
                            bus.Code_Circuit = gridV.GetFocusedRowCellDisplayText("Code Circuit");
