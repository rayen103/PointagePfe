...
namespace CST.LePoint.CtrlLibrary
{
    class NombreTouteLettre
    {
        ...
        private String montant = "0.000";
        private Int64 partieEnt = 0;
        ...
        public void setMontant(String montantChiffre) {
            ...
            this.partieEnt = Int64.Parse(split[0]);
            this.partieFraq = int.Parse(split[1]);
        }
        ...
        public string calculer_glob() {
            ...
            if ((partieEnt != 0) && (partieFraq != 0))
                montantLettre = montantLettre + " et ";
            if (partieFraq != 0) 
                montantLettre = montantLettre + calculer(partieFraq) + " " + sousUnite;
            return montantLettre;
        }

        public NombreTouteLettre() {
            unite = "Dinars";
            sousUnite = "Millimes";
        }

        public NombreTouteLettre(String unite, String sousUnite)
        {
            this.unite = unite;
            this.sousUnite = sousUnite;
        }
