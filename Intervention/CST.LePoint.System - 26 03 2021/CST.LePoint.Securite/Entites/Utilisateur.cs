...
namespace CST.LePoint.Securite.Entites
{
    ...
    public class Utilisateur
    {
        public Utilisateur()
        {
            utilisateurSite = new List<UtilisateurSite>();
        ...
        [DataMember]
        public List<UtilisateurSite> utilisateurSite { get; set; }
            ...
            using (SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["CST_ConnectionString"].ConnectionString))
            {
                ...
                try
                {
                   ...
                   // cmd.ExecuteNonQuery();
                    ...
                    UtilisateurSite.Supprimer(transaction, this.Login);
                    foreach (UtilisateurSite usite in this.utilisateurSite)
                    {
                        usite.Sauvegarder(transaction);
                    }
