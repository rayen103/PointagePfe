...
export class EmployeDialogComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.form = this._formBuilder.group({
            ...
            typeEmploye: [this.data.employe?.typeEmploye || 'EmployeSimple', [Validators.required]],
            codeCircuit: [this.data.employe?.codeCircuit, [Validators.required, Validators.maxLength(50)]],
            codePointCollecte: [this.data.employe?.codePointCollecte, [Validators.required, Validators.maxLength(50)]],
